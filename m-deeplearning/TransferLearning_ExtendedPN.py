...
from TransferLearningPN import *
...
def train_and_eval(_base_model_file, _train_image_folder, _test_image_folder, _results_file, _new_model_file,fold,train_map_file,test_map_file, testing = False):
   ...
   # train_map_file = "mapPNtrain.txt"
   # test_map_file = "mapPNtest.txt"
...
if __name__ == '__main__':
    ...
    for fold in range(1, foldNumbers):
        results_file = os.path.join(base_folder, "Output", "predictions_PN"+str(fold)+".txt")
        new_model_file = os.path.join(base_folder, "Output", "TransferLearning_PN"+str(fold)+".model")
        train_and_eval(base_model_file, train_image_folder, test_image_folder, results_file, new_model_file,5,"mapPNtrainF"+str(fold)+".txt","mapPNtestF"+str(fold)+".txt")
